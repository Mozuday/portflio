...
const About = () => {
  ...
  I'm Uday Sharma, a Full-Stack Developer specializing in MERN Stack
  development and Python. I build scalable web applications, REST APIs,
  authentication systems, and database-driven platforms that solve
  real-world business problems. My focus is creating fast, responsive,
  and user-friendly digital experiences with clean and maintainable code.
</p>

<p className="text-lg text-white/80 mb-6">
  I have worked with freelance clients through Fiverr, Upwork, and local
  businesses, delivering custom websites and full-stack solutions across
  various industries. My professional experience includes a Web Developer
  Internship at Labmentix and my current role as a Software Maintenance
  Associate at Rana Sugars Ltd., where I contribute to software support,
  troubleshooting, and system improvements.
</p>

<p className="text-lg text-white/80 mb-6">
  My expertise includes React.js, Node.js, Express.js, MongoDB,
  PostgreSQL, MySQL, JavaScript, Python, Tailwind CSS, API integration,
  JWT authentication, OAuth, Git, GitHub, and Docker. I enjoy building
  complete products from idea to deployment while continuously learning
  modern technologies and development best practices.
</p>
...
<ul className="space-y-2 text-white/70">
  ...
  <li className="flex items-start">
    <span className="text-theme-pink mr-2">●</span>
    <span>REST API Design & Integration</span>
  </li>

  <li className="flex items-start">
    <span className="text-theme-pink mr-2">●</span>
    <span>Authentication & Security (JWT/OAuth)</span>
  </li>
